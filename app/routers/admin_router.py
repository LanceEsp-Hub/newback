...
#         models.User.name.label("reported_user_name"),
#         models.User.email.label("reported_user_email")
#     ).join(
#         models.User, models.UserReport.reporter_id == models.User.id
#     ).join(
#         models.User, models.UserReport.reported_user_id == models.User.id
#     ).filter(
...
#             "reason": report.UserReport.reason,
#             "description": report.UserReport.description,
#             "status": report.UserReport.status,
#             "created_at": report.UserReport.created_at.isoformat(),
#             "reviewed_at": report.UserReport.reviewed_at.isoformat() if report.UserReport.reviewed_at else None
...
#     query = db.query(
#         models.BlockedUser,
#         models.User.name.label("blocker_name"),
#         models.User.email.label("blocker_email"),
#         models.User.profile_picture.label("blocker_profile_picture"),
#         models.User.name.label("blocked_user_name"),
#         models.User.email.label("blocked_user_email"),
#         models.User.profile_picture.label("blocked_user_profile_picture")
#     ).join(
#         models.User, models.BlockedUser.blocker_id == models.User.id
#     ).join(
#         models.User, models.BlockedUser.blocked_user_id == models.User.id
#     ).order_by(
#         models.BlockedUser.created_at.desc()
#     )
...
#     # Apply pagination
#     blocked_users = query.offset((page - 1) * limit).limit(limit).all()
...
#             "blocker_name": block.blocker_name,
#             "blocker_email": block.blocker_email,
#             "blocker_profile_picture": block.blocker_profile_picture,
#             "blocked_user_name": block.blocked_user_name,
#             "blocked_user_email": block.blocked_user_email,
#             "blocked_user_profile_picture": block.blocked_user_profile_picture,
#             "created_at": block.BlockedUser.created_at.isoformat()
...
#             "story": story.story,
#             "image_filenames": story.image_filenames,
...
#     # Storage Statistics
#     upload_paths = {
#         "messages": "backend/app/uploads/messages",
#         "pet_images": "backend/app/uploads/pet_images", 
#         "profile_pictures": "backend/app/uploads/profile_pictures",
#         "success_stories": "backend/app/uploads/success_stories"
#     }
...
#             func.sum(func.cast(models.PetSimilaritySearch.was_successful, db.Integer)).label('successful_searches')
#         ).filter(
...
#                 "failed_searches": record.total_searches - (record.successful_searches or 0)
#             })
...
#         cat_name=story_data.get("cat_name"),
#         story=story_data.get("story"),
#         image_filenames=story_data.get("images", [])
#     )
